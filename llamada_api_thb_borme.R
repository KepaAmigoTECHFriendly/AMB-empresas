...
llamada_atributos <- function(){
  ...
  json_activo <- GET(url_activo_ermua, add_headers("Content-Type"="application/json","Accept"="application/json","X-Authorization"="Bearer eyJhbGciOiJIUzUxMiJ9..RH-VMiu6sYI-TElqfgfjzCIACTF1nBaBgeLZBhu9THjFtvigFwM3v9deRNH2iwKbwN0-cBYWtrmN3m5dpihwfQ"))
